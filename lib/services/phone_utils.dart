/// Phone number normalization, mirroring src/lib/phone.ts on the web.
///
/// Phone is the church's real contact channel — many members have no email at
/// all. Validation stays deliberately permissive: an Ethiopian number typed any
...
/// The shortest run of digits that could plausibly be a phone number.
/// Ethiopian subscriber numbers are 9 digits after the trunk 0, so anything
/// shorter is a typo rather than an unusual format.
const int _minDigits = 9;

final RegExp _leadingInternational = RegExp(r'^(\+|00)');
...
String? normalizeEthiopianPhone(String? raw) {
  ...
  final international = _leadingInternational.hasMatch(trimmed);
