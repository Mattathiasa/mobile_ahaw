...
import '../screens/dashboard_items/organisation_page.dart';
...
class _MainDrawerState extends State<MainDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    final navItems = [
      ...
      const _NavItem(FontAwesomeIcons.bookOpenReader,    'Teachings',      TeachingsPage(),         'canViewTeachings', 'teachings'), // collection stays `teachings`; label is now Sermons
    ...
    final adminItems = [
      ...
      const _NavItem(FontAwesomeIcons.sitemap, 'Organisation',     OrganisationPage(),      'canViewHierarchy', 'organisation'),
